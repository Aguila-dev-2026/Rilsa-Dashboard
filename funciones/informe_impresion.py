...
def generar_informe_impresion(datos: pd.DataFrame) -> str:
    ...
    partes = [
        "<style>"
        ".riles-print-root{display:none}.riles-print-report{background:#fff;color:#171514;font-family:Arial,sans-serif}.riles-print-report table{width:100%;border-collapse:collapse;font-size:8pt}.riles-print-report th{background:#6d1f2b!important;color:#fff!important}.riles-print-report th,.riles-print-report td{border:1px solid #ddd5ca;padding:4px;text-align:left}.riles-print-report tr:nth-child(even){background:#f4f0e9!important}.riles-print-report .ficha{max-width:680px}.riles-print-report .bloque{break-inside:avoid;margin:16px 0 25px}.riles-print-report svg{width:100%;max-width:600px;height:auto}.riles-print-report .serie{stroke:#6d1f2b;stroke-width:2}.riles-print-report .eje{stroke:#756e67;stroke-width:.7}.riles-print-report svg text{font-size:8px;fill:#756e67}"
        "@media print{@page{size:auto;margin:14mm}html,body{background:#fff!important;color:#171514!important;color-scheme:light!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}header,[data-testid='stSidebar'],[data-testid='stToolbar'],footer{display:none!important}[data-testid='stElementContainer']:not(:has(#riles-print-root)),.stElementContainer:not(:has(#riles-print-root)){display:none!important}[data-testid='stElementContainer']:has(#riles-print-root),.stElementContainer:has(#riles-print-root){display:block!important}.riles-print-root{display:block!important}.riles-print-report{display:block!important;background:#fff!important;color:#171514!important}.riles-print-report h1{color:#48121a!important;font-size:22pt}.riles-print-report h2{color:#6d1f2b!important;margin-top:22px}.riles-print-report h3{margin-bottom:6px}.riles-print-report .salto-area{break-before:page}.riles-print-report table{font-size:7pt;background:#fff!important}.riles-print-report thead{display:table-header-group}.riles-print-report tr{break-inside:avoid}}"
        "</style><div id='riles-print-root' class='riles-print-root'><section class='riles-print-report'><h1>Informe operacional completo</h1>"
    ...
    return "".join(partes) + "</section></div>"
