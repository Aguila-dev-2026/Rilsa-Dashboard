...
def generar_informe_impresion(datos: pd.DataFrame) -> str:
    ...
    partes = [
        ...
        "@media print{header,[data-testid='stSidebar'],[data-testid='stToolbar'],footer{display:none!important}.stElementContainer:not(:has(.riles-print-report)){display:none!important}.stElementContainer:has(.riles-print-report){display:block!important}.riles-print-report{display:block!important;color:#171514;font-family:Arial,sans-serif}.riles-print-report h1{color:#48121a;font-size:22pt}.riles-print-report h2{color:#6d1f2b;margin-top:22px}.riles-print-report h3{margin-bottom:6px}.riles-print-report .salto-area{break-before:page}.riles-print-report table{font-size:7pt}.riles-print-report thead{display:table-header-group}.riles-print-report tr{break-inside:avoid}}"
        "</style><section class='riles-print-report'><h1>Informe operacional completo</h1>"
        "<p>Generado para impresión desde el Dashboard Operacional Planta RILES. Incluye todas las áreas, parámetros y registros disponibles.</p>"
